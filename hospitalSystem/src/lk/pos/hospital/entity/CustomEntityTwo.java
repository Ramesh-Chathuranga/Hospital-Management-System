...
public class CustomEntityTwo extends SuperEntity {
    private String pid;
    ...
    public CustomEntityTwo() {
    }

    public CustomEntityTwo(String pid, String pname,String wid, String bid, LocalDate date, LocalDate discharchdate) {
        this.pid = pid;
        this.pname=pname;
        this.wid = wid;
        this.bid = bid;
